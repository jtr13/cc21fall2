...
## 2 Radar chart using ggradar


### 2.1 Installation


#### 2.1.1 Install by devtools
&nbsp;
...
#### 2.1.2 Unzip package in the R directory
&nbsp;
...
### 2.3 Parameters Usage

#### 2.3.1 Change text size
...
#### 2.3.2 Set the bar value for each grid
...
#### 2.3.3 Set the split ratio for each grid
...
#### 2.3.5 Background and styles of grid lines.  
...
### 3.3 Parameters Usage



#### 3.3.1 Change the axistype
...
#### 3.3.4 Modify Lines' Apperance (color/type/width)
...
#### 3.3.5 Modify the axislines (color/type/width)
