...
## 2. Basic Visualization of Treemap
...
## 3. Visualization using treemapify package
...
### 3.1 Plot a simple Treemap figure
```{r}
...
### 3.2 Add labels onto the treemap
