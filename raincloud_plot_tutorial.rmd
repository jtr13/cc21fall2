...
### 2. Components of raincloud plot.
...
#### 2.1 Tailoring out the cloud: halved violin
...
#### 2.2 Making it rain: jittered points
...
#### 2.3 Adding the box to "collect" the rain: boxplot
...
#### 3.1 Grouped Categorical X + Numerical Y
...
#### 3.2 Categorical X1 + Numerical X2 + Numerical Y
...
#### 3.3 Grouped Numerical X + Grouped Numerical Y
