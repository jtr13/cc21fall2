...
```{r, include=FALSE}
# IMPORTANT NOTE! This file has been modified to output exactly what the code should display, without actually evaluating the code. Actual code evaluation would require an API key. This can be done, but for the sake of convenience in bookdown builds (and knowing that the code file need not be used directly), I have simply created a file that mocks the actual output. The original code file can be provided if needed.
...
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/geocode/json?address=Paris&key=xxx")
```
```{r, echo=FALSE}
writeLines("# A tibble: 1 x 2\n    lon   lat\n  <dbl> <dbl>\n1  2.35  48.9")
```
...
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/staticmap?center=parthenon,%20athens&zoom=10&size=640x640&scale=2&maptype=terrain&language=en-EN&key=xxx")
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/geocode/json?address=parthenon,+athens&key=xxx")
```
```{r, eval=FALSE}
...
parthenon_map
```
![](resources/ggmap_tutorial_images/unnamed-chunk-6-1.png)
...
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/staticmap?center=parthenon,%20athens&zoom=16&size=640x640&scale=2&maptype=terrain&language=en-EN&key=xxx")
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/geocode/json?address=parthenon,+athens&key=xxx")
```
...
parthenon_map
```
![](resources/ggmap_tutorial_images/unnamed-chunk-7-1.png)
...
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/staticmap?center=36.1,-112&zoom=9&size=640x640&scale=2&maptype=terrain&language=en-EN&key=xxx")
```
```{r, eval=FALSE}
...
grand_canyon_map
```
![](resources/ggmap_tutorial_images/unnamed-chunk-8-1.png)
...
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/staticmap?center=manhattan&zoom=12&size=640x640&scale=2&maptype=terrain&language=en-EN&key=xxx")
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/geocode/json?address=manhattan&key=xxx")
```
```{r, eval=FALSE}
ggmap(nyc) +
...
```
```{r, echo=FALSE}
writeLines("Warning: Removed 1091 rows containing missing values (geom_point).")
```
![](resources/ggmap_tutorial_images/unnamed-chunk-10-1.png)
...
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/staticmap?center=manhattan&zoom=12&size=640x640&scale=2&maptype=terrain&key=xxx")
writeLines("Source : https://maps.googleapis.com/maps/api/geocode/json?address=manhattan&key=xxx")
writeLines("Source : http://tile.stamen.com/toner/12/1205/1537.png")
writeLines("Source : http://tile.stamen.com/toner/12/1206/1537.png")
writeLines("Source : http://tile.stamen.com/toner/12/1207/1537.png")
writeLines("Source : http://tile.stamen.com/toner/12/1205/1538.png")
writeLines("Source : http://tile.stamen.com/toner/12/1206/1538.png")
writeLines("Source : http://tile.stamen.com/toner/12/1207/1538.png")
writeLines("Source : http://tile.stamen.com/toner/12/1205/1539.png")
writeLines("Source : http://tile.stamen.com/toner/12/1206/1539.png")
writeLines("Source : http://tile.stamen.com/toner/12/1207/1539.png")
writeLines("Source : http://tile.stamen.com/toner/12/1205/1540.png")
writeLines("Source : http://tile.stamen.com/toner/12/1206/1540.png")
writeLines("Source : http://tile.stamen.com/toner/12/1207/1540.png")
```
```{r, eval=FALSE}
...
writeLines("Warning: Removed 1091 rows containing missing values (geom_point).")
```
![](resources/ggmap_tutorial_images/unnamed-chunk-11-1.png)
...
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/staticmap?center=40.8,-73.96&zoom=14&size=640x640&scale=2&maptype=terrain&key=xxx")
writeLines("Source : http://tile.stamen.com/toner/14/4824/6153.png")
writeLines("Source : http://tile.stamen.com/toner/14/4825/6153.png")
writeLines("Source : http://tile.stamen.com/toner/14/4826/6153.png")
writeLines("Source : http://tile.stamen.com/toner/14/4827/6153.png")
writeLines("Source : http://tile.stamen.com/toner/14/4824/6154.png")
writeLines("Source : http://tile.stamen.com/toner/14/4825/6154.png")
writeLines("Source : http://tile.stamen.com/toner/14/4826/6154.png")
writeLines("Source : http://tile.stamen.com/toner/14/4827/6154.png")
writeLines("Source : http://tile.stamen.com/toner/14/4824/6155.png")
writeLines("Source : http://tile.stamen.com/toner/14/4825/6155.png")
writeLines("Source : http://tile.stamen.com/toner/14/4826/6155.png")
writeLines("Source : http://tile.stamen.com/toner/14/4827/6155.png")
writeLines("Source : http://tile.stamen.com/toner/14/4824/6156.png")
writeLines("Source : http://tile.stamen.com/toner/14/4825/6156.png")
writeLines("Source : http://tile.stamen.com/toner/14/4826/6156.png")
writeLines("Source : http://tile.stamen.com/toner/14/4827/6156.png")
```
```{r, eval=FALSE}
ggmap(nyc, extent = 'device', legend = "topleft") +
...
```
```{r, echo=FALSE}
writeLines("Warning: Removed 2856 rows containing non-finite values (stat_bin2d).")
writeLines("Warning: Removed 2 rows containing missing values (geom_tile).")
```
![](resources/ggmap_tutorial_images/unnamed-chunk-12-1.png)
...
```
```{r, echo=FALSE}
writeLines("Warning: Removed 1091 rows containing non-finite values (stat_density2d_filled).")
```
![](resources/ggmap_tutorial_images/unnamed-chunk-13-1.png)
...
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/directions/json?origin=Columbia+University&destination=Frederick+Douglass+Circle&key=xxx&mode=walking&alternatives=false&units=metric")
```
```{r, eval=FALSE}
nyc <- get_map(location = c(-73.96, 40.803), zoom = 16, color = 'bw')
```
```{r, echo=FALSE}
writeLines("Source : https://maps.googleapis.com/maps/api/staticmap?center=40.803,-73.96&zoom=16&size=640x640&scale=2&maptype=terrain&language=en-EN&key=xxx")
```
```{r, eval=FALSE}
ggmap(nyc) +
...
```
```{r, echo=FALSE}
writeLines("Warning: Removed 3274 rows containing missing values (geom_point).")
```
![](resources/ggmap_tutorial_images/unnamed-chunk-14-1.png)
