...
We introduce the function `plot_density`, that adjusts itself in the presence of non-negative, non-positive or real data to avoid assigning density to unlikely values, and also automatically detects the presence of significant repeated values in the data.
...
### 1) Non-negative data with repetitions
...
### 2) Non-positive data with repetitions
...
### 4) Real data without repetitions
